...
import { EvenBinsHistogramTestSuite, CustomBinsHistogramTestSuite, RadixHistogramSinglePassTestSuite, RadixHistogramMultiPassTestSuite, RadixHistogramMultiPass8TestSuite } from "./baseHistogram.mjs"
...
async function main(navigator) {
  ...
  /*let testSuites = [
    EvenBinsHistogramTestSuite, 
    CustomBinsHistogramTestSuite,
    RadixHistogramSinglePassTestSuite,
    RadixHistogramMultiPassTestSuite
  ];*/
